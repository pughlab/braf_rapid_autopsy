...
TreeViewer.prototype.render = function(dataset) {
  ...
  d3.json(dataset.summary_path, function(summary) {
    ...
    tree_container.find('tr').click(function(evt) {
      ...
      if(ds_name == "RAP1"  || ds_name == "Patient1"){
          var tidx = 1367
      }else if (ds_name == "RAP2"  || ds_name == "Patient2") {
          var tidx = 78
      }else if (ds_name == "RAP3"  || ds_name == "Patient3") {
          var tidx = 2108
      }else if (ds_name == "RAP4"  || ds_name == "Patient4") {
          var tidx = 402
      }else if (ds_name == "RAP5"  || ds_name == "Patient5") {
          var tidx = 1404
      }else if (ds_name == "RAP6"  || ds_name == "Patient6") {
          var tidx = 141
      }else if (ds_name == "RAP7"  || ds_name == "Patient7") {
          var tidx = 1690
      }
